...
layout: skills
title: Skills
description: "Know how and personal goals."
...
<section id="two" class="spotlights">
	<section id="clean">
		<a href="#reusability" class="image">
		...
		<div class="content">
			<div class="inner">
				...
				<ul class="actions">
					<li><a href="#reusability" class="button scrolly">Read more</a></li>
				</ul>
			</div>
		</div>
	</section>
	<section id="reusability">
		<a href="#integration" class="image">
		...
		<div class="content">
			<div class="inner">
				...
				<ul class="actions">
					<li><a href="#integration" class="button scrolly">Read more</a></li>
				</ul>
			</div>
		</div>
	</section>
	<section id="integration">
		<a href="#scalability" class="image">
...
<section id="cutting-edge">
	<div class="inner">
		...
		<ul class="actions">
			<li><a href="#contact" class="button next scrolly">Connect</a></li>
		</ul>
	</div>
</section>
